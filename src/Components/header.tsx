...
const Header:React.FC<header>  =(value) => {
        return (
                <header className='bg-red-400 height:100px'>
                ...
                <nav className='justify-between flex  flex-grow items-center'>
                        ...
                        <ul className='basic-3/6  flex items-center justify-end gap-8 text-sm text-blue-800 font-medium' >
                                <li className='cursor-pointer py-2 hover:text-gray-950 relative after:absolute after:bottom-0 after:left-0 after:bg-slate-950 after:h-0.5 after:w-0 hover:after:w-full after:transition-all after:ease-in-out after:duration-500'>
                        ...
                        <ul className='basic-1/6 ml-16 uppercase text-sm text-rose-600'>
                                <li className='top-menu-item'>
